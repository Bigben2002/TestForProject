...
Prettier는 코드 스타일을 자동으로 정리해주는 도구이다.

협업 프로젝트에서는 개발자마다 코드 스타일이 다르기 때문에
Prettier를 사용하여 코드 포맷을 자동으로 통일한다.
...
VS Code Extension에서 설치

Prettier - Code formatter
기본 설정

VS Code 설정에서 다음 옵션을 활성화한다.
...
ESLint는 JavaScript / TypeScript 코드의 오류와 규칙을 검사하는 도구이다.

코드 작성 중 발생할 수 있는 잠재적인 버그를 미리 발견할 수 있다.
